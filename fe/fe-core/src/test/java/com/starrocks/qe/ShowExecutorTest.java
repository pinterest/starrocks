...
public class ShowExecutorTest {
    ...
    private void verifyShowMaterializedViewResult(ShowResultSet resultSet) throws AnalysisException, DdlException {
        ...
        Assertions.assertEquals("10", resultSet.getString(mvSchemaTable.size() - 5));
        Assertions.assertEquals(expectedSqlText, resultSet.getString(mvSchemaTable.size() - 4));
        Assertions.assertEquals("", resultSet.getString(mvSchemaTable.size() - 3));
        Assertions.assertTrue(resultSet.getString(mvSchemaTable.size() - 2).contains("UNKNOWN"));
        Assertions.assertEquals("", resultSet.getString(mvSchemaTable.size() - 1));
        Assertions.assertFalse(resultSet.next());
    }
